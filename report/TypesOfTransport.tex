...
\begin{figure}
	\begin{subfigure}[]{0.4\textwidth}
		\includegraphics[]{MobilityInTheCityJPG/Graphs/Motorways.pdf}
		\caption{Motorway and major road network}
		\label{Motorways}
	\end{subfigure}
	\begin{subfigure}[]{0.4\textwidth}
		\includegraphics[]{MobilityInTheCityJPG/Graphs/PTnetwork.pdf}
