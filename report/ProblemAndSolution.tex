...
The ticket prices for public transport in Berlin are the 5th most expensive of the whole world, this is visibly at figure \ref{pricePT}. As a single ticket costs around \texteuro{3.16} and majority of the commuting people need to cover on average 14.3 Km (figure \ref{averageComDis} 2012) to go working. With an average fuel consumption of 4.1 L/100Km (2020) and a fuel price of  \texteuro{1,65}/L (2021) this means going to work with the car cost around \texteuro{1} (car parks payment not included). So for people that own a car and do have a car parks spot near their work it financially seems to be more attractive to take the car . 
